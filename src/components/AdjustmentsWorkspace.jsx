            ...
            <div className="lg:h-[65vh] overflow-y-auto pr-2 space-y-4">
              ...
              <div className='p-2 border-b border-gray-700'>
                ...
                <input type="range" id="brightness-slider" min="0" max="200" value={brightnessValue}
                  ...
                  disabled={!imageSrc}
                  className="w-full h-2 bg-gradient-to-r from-gray-900 via-gray-400 to-white rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
              ...
              <div className='p-2 border-b border-gray-700'>
                ...
                <input type="range" id="sharpness-slider" min="0" max="100" value={sharpnessValue}
                  ...
                  disabled={!imageSrc}
                  className="w-full h-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
              ...
              <div className='p-2 border-b border-gray-700'>
                ...
                <input type="range" id="saturation-slider" min="0" max="300" value={saturationValue}
                  ...
                  disabled={!imageSrc}
                  className="w-full h-2 bg-gradient-to-r from-gray-500 via-pink-400 to-red-600 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
              ...
              <div className='p-2 border-b border-gray-700'>
                ...
                <input type="range" id="hue-slider" min="0" max="360" value={hueValue}
                  ...
                  disabled={!imageSrc}
                  className="w-full h-2 bg-gradient-to-r from-red-500 via-green-500 to-blue-500 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
              ...
              <div className='p-2 border-b border-gray-700'>
                ...
                <input type="range" id="sepia-slider" min="0" max="100" value={sepiaValue}
                  ...
                  disabled={!imageSrc}
                  className="w-full h-2 bg-gradient-to-r from-white to-orange-800 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>
              ...
              <div className='p-2'>
                ...
                <input type="range" id="grayscale-slider" min="0" max="100" value={grayscaleValue}
                  ...
                  disabled={!imageSrc}
                  className="w-full h-2 bg-gradient-to-r from-gray-900 to-gray-400 rounded-lg appearance-none cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" />
              </div>

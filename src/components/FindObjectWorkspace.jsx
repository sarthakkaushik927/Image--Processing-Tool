...
        processFile(file); // ⬅️ Use the new reusable function
    };
    
...
            <div 
                className="bg-[#1f1f3d]/50 p-6 flex flex-col items-center border-2 border-indigo-400/30 rounded-2xl"
            >
...
                >
                    {originalImage ? (
                        <img src={processedImageURL || originalImage} alt="Input" className="max-w-full max-h-full object-contain pointer-events-none" />
                    ) : (
